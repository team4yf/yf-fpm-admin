  ...
  render: () => {
    return (
      <div className="">
        ...
        <div className="container ">
          <h2>Colors</h2>
          <p>Using Materials Colors : <a className="waves-effect waves-light btn blue lighten-2" target="_blank" href="http://www.materializecss.cn/color">http://www.materializecss.cn/color</a></p>
          <h2>ICons</h2>
...
export {Footer, Header, Nav, Welcome}
